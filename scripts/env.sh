...
# AWS split-host addresses (used by launch_*_aws.sh and OpenC3 plugin build)
GSW_IP="${GSW_IP:-10.10.20.10}"
SAT_IP="${SAT_IP:-10.10.10.10}"
OPS_IP="${OPS_IP:-10.10.20.20}"
OPENC3_URL="https://${GSW_IP}/"
NOS3_DEPLOY="${NOS3_DEPLOY:-aws}"

# Detached containers for headless / cloud launch scripts
DCALL_RUN="docker run -dit"
