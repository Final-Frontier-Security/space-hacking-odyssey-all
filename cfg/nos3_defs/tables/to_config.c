...
{
   {
       ...
       {CFE_SB_MSGID_WRAP_VALUE(CFDP_FILEDOWNLOAD_TLM_MID),   {0,0},  4200, 0xffff,    TO_GROUP_APP | TO_MGROUP_ONE, 0,1},
       {CFE_SB_MSGID_WRAP_VALUE(IPS_HK_TLM_MID),              {0,0},  64,  0xffff,     TO_GROUP_APP | TO_MGROUP_ONE, 0,1},
