...
class THRUSTER_Functional_Test < Cosmos::Test
  def setup
...
class THRUSTER_Automated_Scenario_Test < Cosmos::Test
  def setup 
    safe_generic_thruster()
  end
...
class Generic_thruster_Test < Cosmos::TestSuite
  def initialize
      super()
      add_test('THRUSTER_Functional_Test')
      #add_test('THRUSTER_Automated_Scenario_Test')
  end
