...
class STAR_TRACKER_Functional_Test < Cosmos::Test
  def setup
...
class STAR_TRACKER_Automated_Scenario_Test < Cosmos::Test
  def setup 
      safe_generic_star_tracker()
  end
...
class Generic_st_Test < Cosmos::TestSuite
  def initialize
      super()
      add_test('STAR_TRACKER_Functional_Test')
      add_test('STAR_TRACKER_Automated_Scenario_Test')
  end
